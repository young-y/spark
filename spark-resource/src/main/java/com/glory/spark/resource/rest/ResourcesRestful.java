...
package com.glory.spark.resource.rest;
...
public class ResourcesRestful {

	private ResourcesRouteService service;
	/**
	...
	@Autowired
	public void setService(ResourcesRouteService service) {
