...
public interface CompensateProcessService {

	CompensateResponse process(CompensateItem item);

	default CompensateResponse process(CompensateItemRequest request){
