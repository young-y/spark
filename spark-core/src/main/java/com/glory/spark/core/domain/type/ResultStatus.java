...
public enum ResultStatus implements PersistableEnum<Integer>{
    ...
    public static class ResultStatusConverter implements Converter<Integer,ResultStatus> {

        @Override
        public ResultStatus convert(@Nonnull Integer source) {
            return ResultStatus.fromPersistableValue(source);
        }
    }
}
